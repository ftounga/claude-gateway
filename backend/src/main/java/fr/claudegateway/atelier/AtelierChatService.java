...
public class AtelierChatService implements RelayInterruptTarget {
    ...
    /**
     * L'outil {@code record_blocker} <b>et sa garde</b> (F-154 / SF-154-02) : inscrit dans le terminal
    ...
    /** Exécution de {@code record_blocker} (F-154 / SF-154-02) ; {@code null} pour les formes historiques. */
    private fr.claudegateway.atelier.actions.TerminalActionToolExecutor terminalActionToolExecutor;

    /**
     * Branche l'outil des actions à faire (F-154 / SF-154-02) par mutateur, comme les autres outils de
    ...
    /**
     * Inscrit une action que l'utilisateur seul peut faire (F-154 / SF-154-02).
     *
