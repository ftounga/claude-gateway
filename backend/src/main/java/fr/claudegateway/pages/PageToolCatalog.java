...
public class PageToolCatalog {
    ...
    public static final String DESIGN_GUIDE = "--- Pages (documents graphiques) ---\n"
            ...
            + "qui est supposé se marque « (supposé) ». Les icônes cloud OFFICIELLES (AWS/Azure) ne sont pas "
            + "disponibles ici (hors ligne) : architecture-beta rend la structure avec des icônes génériques. "
            + "Un bloc invalide n'empêche pas la page : son code s'affiche avec un message.\n"
