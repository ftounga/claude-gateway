 ...
 * cela du service des postes, et rien ne justifie qu'un composant de protocole voie toute la
 * surface de {@link RunnerHostService}. Il rend aussi le comportement vérifiable sans base de
...
public interface RunnerShellRecorder {
    ...
    /**
     * Enregistre le genre déclaré pour ce poste.
     *
     ...
     */
    void recordRunnerShell(UUID hostId, String declared);
}
