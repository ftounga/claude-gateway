 ...
 *
 * <p>{@code elevated} dit si le runner tourne avec les droits de l'administrateur
 * (F-38 / SF-38-18) : la gateway ne peut pas le deviner, et c'est au moment d'autoriser une commande
 * que l'information compte. Facultatif, comme le reste.</p>
 *
