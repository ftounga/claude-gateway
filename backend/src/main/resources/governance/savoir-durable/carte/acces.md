...
> Un client VPN par ligne. La colonne « incompatible avec » est celle qu'on relit le jour où
> deux tunnels refusent de cohabiter — et ce jour arrive.
...
> Qui a quoi, et **par quel geste** on l'obtient. Le délai d'obtention est un fait : il se note.
