...
class HostProjectsApiIntegrationTest {
    ...
    void aFolderBecomesAProjectNamedAfterIt() throws Exception {
        ...
        assertThat(workspaceRepository.findByUserIdAndHostIdAndHostTerminalFalseAndTeamsTerminalFalse(aliceId, aliceHost.getId())).hasSize(1);
    }
    ...
    void anEscapingPathIsRefusedAndCreatesNothing() throws Exception {
        ...
        assertThat(workspaceRepository.findByUserIdAndHostIdAndHostTerminalFalseAndTeamsTerminalFalse(aliceId, aliceHost.getId())).isEmpty();
    }
    ...
    void severalFoldersBecomeSeveralProjectsWithoutAnyPairing() throws Exception {
        ...
        assertThat(workspaceRepository.findByUserIdAndHostIdAndHostTerminalFalseAndTeamsTerminalFalse(aliceId, aliceHost.getId())).hasSize(3);
    }
}
