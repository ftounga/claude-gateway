...
export class AtelierComponent implements OnInit, OnDestroy {
  ...
  // vivent sur la carte « Hébergé » de l'accueil de la Forge, où ils sont enfin à leur place —
  // un dépôt ou une archive n'a pas de machine. Le bouton « Nouveau projet » qui les portait
  // faisait partir du PROJET au lieu du poste, et c'est de là que venait la confusion.
   ...
   *
   * <p>Il ouvrait jusqu'ici le parcours « Sur ma machine », c'est-à-dire celui qui part du
   * <b>projet</b> — le défaut même que F-72 supprime : on créait un projet en croyant déclarer un
   * client, puis on redemandait un poste. Le guide n'a rien à recopier : il conduit là où les deux
   * gestes sont, dans le bon ordre.</p>
   */
